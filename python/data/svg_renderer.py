...
from python.data.models import (
    DrawableObject, Line, Circle, Ellipse, Rectangle, Polygon, Polyline, 
    Arc, Text, Path, Group, Layer, Drawing, Color, FillStyle, LineStyle,
...
def render_ellipse(ellipse: Ellipse, defs: List[str]) -> str:
    ...
    if ellipse.rotation != 0:
        attrs.append(f'transform="rotate({ellipse.rotation} {ellipse.center.x} {ellipse.center.y})"')
