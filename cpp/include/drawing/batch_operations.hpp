...
public:
    ...
    struct CollisionPair {
        ObjectStorage::ObjectID id1;
        ObjectStorage::ObjectID id2;
    };
    ...
    // Pattern generation
    static std::vector<ObjectStorage::ObjectID> create_grid(ObjectStorage& storage,
                                                           ObjectType type,
                                                           int rows, int cols,
                                                           float cell_width, float cell_height,
                                                           float x_offset = 0, float y_offset = 0);
    
    static std::vector<ObjectStorage::ObjectID> create_circular_pattern(ObjectStorage& storage,
                                                                      ObjectType type,
                                                                      int count,
                                                                      float radius,
    ...
    static BoundingBox get_object_bbox(const ObjectStorage& storage, ObjectStorage::ObjectID id);
    
private:
    // Helper to get object center
    static Point get_object_center(const ObjectStorage& storage, ObjectStorage::ObjectID id);
    
    // Helper to set object position
    static void set_object_position(ObjectStorage& storage, ObjectStorage::ObjectID id, 
                                   float x, float y);
};
