...
def test_path_basic():
    ...
    path3 = drawing.add_path(
        "M 300 300 C 350 250 450 250 500 300", stroke_color=(255, 0, 255), stroke_width=3
    )
    print(f"Created curved path: ID={path3}")

    # Test path with quadratic Bezier
    path4 = drawing.add_path("M 50 400 Q 150 350 250 400", stroke_color=(255, 128, 0))
    ...
    # Test arc paths
    print("\nTesting arc paths...")
    arc_path = drawing.add_path("M 100 500 A 50 50 0 0 1 200 500", stroke_color=(0, 255, 255))
